 ...
 * @desc 直接内存访问 ByteBuffer: 在JVM堆上分配空间，其最大内存，受到最大堆的限制 DirectBuffer:
 *       直接分配在物理内存中，并不占用堆空间
 * 
...
public class DirectBufferTest {
	/*
	 * DirectBuffer: 19 ByteBuffer: 23 可见 仅内存访问速度而言 DirectBuffer 比 ByteBuffer快
	 * DirectBuffer for: 17 ByteBuffer for: 9
	 * 
	...
	public static void main(String[] args) {
		...
		System.out.println("DirectBuffer for: "
				+ (System.currentTimeMillis() - begin));
		...
		System.out.println("ByteBuffer for: "
				+ (System.currentTimeMillis() - begin));
	 ...
	 */
	private static void monDirectBuffer() throws ClassNotFoundException,
		...
		synchronized (c) {
			...
			AtomicLong reservedMemoryValue = (AtomicLong) reservedMemory
					.get(null);// 剩余大小
