 ...
 * @see LinkedHashSet LinkedHashMap \
 *      基于hash的快速元素插入、同时维护者元素插入集合时的先后顺序。遍历集合时，按照先进先出的顺序排序
...
public class SetTest {
	public static void main(String[] args) {
		...
		/**
		 * 测试数据如下： HashSet: 33,100,4,9,10 LinkedHashSet: 100,10,4,33,9 TreeSet:
		 * 4,9,10,33,100
		 * 
		 * HashSet 毫无规律可言 LinkedHashSet 输出顺序和输入顺序完全一致 TreeSet 从小到大排序
		 */
