...
public class Demo02 {
	...
	public static void main(String[] args) throws IOException {
		/*
		 * FileWriter FileReader 要优于 OutputStream InputStream 测试的循环次数 count * 10
		 */
		...
		dos.close();
		System.out.println("OutputSream: "
		...
		dos.close();
		System.out.println("Buffered OutputSream: "
				+ (System.currentTimeMillis() - start));
		...
		while (dis.readLine() != null)
			;// 读取数据
		dis.close();
		System.out.println("Buffered InputSream: "
				+ (System.currentTimeMillis() - start));
		...
		bfw.close();
		System.out.println("BufferedFileWriter: "
				+ (System.currentTimeMillis() - start));
		...
		while (bfr.read() != -1)
			;
		bfr.close();
		System.out.println("BufferedFileReader: "
				+ (System.currentTimeMillis() - start));
	}
}
