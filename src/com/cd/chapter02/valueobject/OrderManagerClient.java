...
public class OrderManagerClient {
	...
	public static void main(String[] args) {
		try {
			/*
			 * IOrderManager usermanager = (IOrderManager)
			 * Naming.lookup("OrderManager"); long begin =
			 * System.currentTimeMillis(); for (int i = 0; i < 1000; i++) {
			 * usermanager.getOrder(i);// Value Object模式 } //getOrder spend: 209
			 * System.out.println("getOrder spend: "+
			 * (System.currentTimeMillis() - begin)); begin =
			 * System.currentTimeMillis();
			 * 
			 * for (int i = 0; i < 1000; i++) {
			 * usermanager.getClientName(i);//通过多次交互获取数据
			 * usermanager.getNumber(i); usermanager.getProdName(i); }
			 * 
			...
			/*
			 * BusinessDelegate bd = new BusinessDelegate(); Order o =
			 * bd.getOrder(11); o.setNumber(11); bd.updateOrder(o);
			 */
