...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		IPacketCreator pc = new PacketHttpHeaderCreator(
				new PacketHtmlHeaderCreator(new PacketBodyCreator()));// 核心组件最先构造
		...
		// BufferedOutputStream(new FileOutputStream("a.txt"))); //spend: 7
		// 没有缓冲功能的流对象
		 ...
		 * BufferedOutputStream通过flushBuffer()调用write()提供性能 return <- return <-
		 * return
		 * 
		 * 
		 * 在FileOutputStream.write() 之前会调用 会首先调用 BufferedOutputStream.write()
		 * 116 line
		 * 
